  ...
  return (
   <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-cyan text-[14px] max-w-[500px]">Create an imaginative images through ICre AI and share it on AI Image Gallery</p>
      </div>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-2 text-[#008B8B] text-[15px]">**Once you have created the image you want, you can share it with others in the connections **</p>
          <button
            type="submit"
